...
* [arrow-parens](#require-parens-in-arrow-function-arguments-arrow-parens)
* [arrow-spacing](#require-space-beforeafter-arrow-functions-arrow-arrow-spacing)
* [constructor-super](#verify-calls-of-super-in-constructors-constructor-super)
* [generator-star-spacing](#enforce-spacing-around-the--in-generator-functions-generator-star-spacing)
* [no-class-assign](#disallow-modifying-variables-of-class-declarations-no-class-assign)
* [no-const-assign](#disallow-modifying-variables-that-are-declared-using-const-no-const-assign)
* [no-this-before-super](#disallow-use-of-thissuper-before-calling-super-in-constructors-no-this-before-super)
* [no-var](#require-let-or-const-instead-of-var-no-var)
* [object-shorthand](#require-object-literal-shorthand-syntax-object-shorthand)
* [prefer-const](#suggest-using-const-prefer-const)
* [prefer-spread](#suggest-using-the-spread-operator-instead-of-apply-prefer-spread)
